...
if (isset($_POST['okForm']) && $_POST['okForm'] == 'Continuar') {
    ...
    $inputTextos = $inputDocumentos . "/IMAGENES";
...
$TituloSeccion = "Crear Estructura de Im&aacute;genes";
?>
<!doctype html>
<html lang="es">
    <head>
            ...
            <div class="col-sm-7">
                <div class="text-center border border-dark rounded">                    
                    ...
                    <center>
                        ...
                        <form class="form-horizontal form-outline col-sm-5" name="formUsuarios" id="formUsuarios" method="POST" role="form" action="EstructuraImgs.php" autocomplete="off">
                            <div class="row">
                                <div class="col">
